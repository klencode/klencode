# Guess the number uses the following programming concepts: loops, if-else statements, functions, method calls and random numbers.

import random   # This generates random numbers
...
def askForGuess():
    while True:
        ...
        if guess.isdecimal():
            return int(guess)   # Convert string guess to and integer.

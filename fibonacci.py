...
# sys.set_int_max_str_digits(10000) This increases the limit of digits to avoid a ValueError.

while True:    # Main program loop. # This creates an infinite loop which will continue to execute indefinitely until its is stopped or broken.
    ...
    print()     # This simply adds a newline character to the output.
